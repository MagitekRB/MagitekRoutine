...
namespace Magitek.Logic.Dancer
{
    internal static class Dances
    {
        ...
        public static async Task<bool> StandardStep()
        {
            ...
            if (AoeControl.Enabled && DancerSettings.Instance.UseAoe && Combat.Enemies.Count(r => r.WithinSpellRange(Spells.StandardFinish.Radius)) >= 3)
            {
